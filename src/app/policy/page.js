        ...
        <div className="container">
          <div className="card bg-dark text-white shadow-lg rounded-4 border-0">
            <div className="card-body p-5">
              <h1 className="h1 mb-3 text-center">Privacy Policy</h1>
              ...
              <p className="mb-3">
                ...
                Service. This Privacy Policy was created with Termify.
              </p>
              ...
              <section className="mt-5">
                ...
                <p>
                  ...
                  accessed via this URL: www.ucheokpagu.com
                </p>
                <p>
              ...
              <section className="mt-5">
                <h3 className="h5">What Information Do We Collect?</h3>
                <p>
              ...
              <section className="mt-5">
                ...
                <p>
                  ...
                  disclose personal and non-personal information about you to
                  ...
                  third party, the safety of the public or any person, to
              ...
              <section className="mt-5">
                <h3 className="h5">How Do We Use Your Email Address?</h3>
                <p>
              ...
              <section className="mt-5">
                ...
                <p>
                  ...
                  regulatory obligations, we’ll either remove it from our
                  systems or depersonalize it so that we can't identify you.
                </p>
              </section>

              <section className="mt-5">
                <h3 className="h5">How Do We Protect Your Information?</h3>
                <p>
              ...
              <section className="mt-5">
                ...
                <p>
                  ...
                  located throughout the world, and may be viewed and hosted
                  anywhere in the world, including countries that may not have
                  laws of general applicability regulating the use and transfer
                  of such data. To the fullest extent allowed by applicable law,
              ...
              <section className="mt-5">
                <h3 className="h5">Sale of Business</h3>
                <p>
              ...
              <section className="mt-5">
                <h3 className="h5">Governing Law</h3>
                <p className="mb-3">
              ...
              <section className="mt-5">
                <h3 className="h5">Cookies for Advertising</h3>
                <p>
              ...
              <section className="mt-5">
                <h3 className="h5">Kids' Privacy</h3>
                <p>
              ...
              <section className="mt-5">
                <h3 className="h5">What is GDPR?</h3>
                <p className="mb-3">
              ...
              <section className="mt-5">
                <h3 className="h5">What is personal data?</h3>
                <p className="mb-3">
              ...
              <section className="mt-5">
                <h3 className="h5">Why is GDPR important?</h3>
                <p>
              ...
              <section className="mt-5">
                ...
                <p>
                  ...
                  customer support team is here for you to answer any questions
                  you might have about working with the API.
                </p>
              </section>

              <section className="mt-5">
                <h3 className="h5">California Residents</h3>
                <p className="mb-3">
                ...
                <p className="mb-3">We do not sell the Personal Information of our users.</p>
                <p>
