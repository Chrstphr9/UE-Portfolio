    ...
    <>
      ...
      <div className="bg-black text-white min-vh-100 py-5">
        <div className="container">
          <div className="card bg-dark text-white shadow-lg rounded-4 border-0">
            <div className="card-body p-5">
              <h1 className="h1 mb-3 text-center">Terms & Conditions</h1>
              ...
              <section className="mt-5">
                <h3 className="h5">Definitions and Key Terms</h3>
                <p className="mb-3">
                ...
                <ul className="ms-4">
                  ...
                  <li>
                    ...
                    “Company,” “we,” “us,” or “our,” it refers to Uche
                  ...
                  <li>
                    ...
                    be accessed via this URL: www.Uchenna Okpagu.com
                  </li>
                  <li>
              ...
              <section className="mt-5">
                <h3 className="h5">Restrictions</h3>
              ...
              <section className="mt-5">
                ...
                <p className="mb-3">
                  ...
                  Uchenna Okpagu, you agree to the terms along with Uche
              ...
              <section className="mt-5">
                ...
                <p>
                  ...
                  (collectively, "Suggestions") provided by you to Uche
              ...
              <section className="mt-5">
                <h3 className="h5">Links to Other Websites</h3>
                <p>
              ...
              <section className="mt-5">
                ...
                <p>
                  ...
                  constitute an integral part of the website, and (ii) subject
                  to the terms and conditions of this Agreement.
                </p>
              </section>

              <section className="mt-5">
                <h3 className="h5">Third-Party Services</h3>
                <p className="mb-3">
              ...
              <section className="mt-5">
                ...
                <p>
                  Termination of this Agreement will not limit any of Uche
              ...
              <section className="mt-5">
                <h3 className="h5">Copyright Infringement Notice</h3>
                <p>
              ...
              <section className="mt-5">
                ...
                <p>
                  ...
                  or arising out of your: (a) use of the website; (b) violation
              ...
              <section className="mt-5">
                ...
                <p className="mb-3">
                  ...
                  statutory or otherwise, with respect to the website, including
              ...
              <section className="mt-5">
                <h3 className="h5">Severability</h3>
                <p className="mb-3">
                ...
                <p>
                  ...
                  shall constitute the entire agreement between you and Uche
              ...
              <section className="mt-5">
                ...
                <p>
                  ...
                  shall operate as a waiver of that right or power. Nor shall
                  ...
                  Agreement and any applicable purchase or other terms, the
              ...
              <section className="mt-5">
                <h3 className="h5">Updates to Our Terms</h3>
                <p>
              ...
              <section className="mt-5">
                <h3 className="h5">Intellectual Property</h3>
                <p>
              ...
              <section className="mt-5">
                <h3 className="h5">Agreement to Arbitrate</h3>
                <p>
              ...
              <section className="mt-5">
                <h3 className="h5">Submissions and Privacy</h3>
                <p>
                  ...
                  non-proprietary and will become the sole property of Uche
              ...
              <section className="mt-5">
                ...
                <p>
                  ...
                  goods or services on or through the Services, which terms and
              ...
              <section className="mt-5">
                <h3 className="h5">Typographical Errors</h3>
                <p>
              ...
              <section className="mt-5">
                <h3 className="h5">Miscellaneous</h3>
                <p>
                  ...
                  writing and signed by an authorized representative of Uche
                  ...
                  by you. Uchenna Okpagu operates and controls the Uche
